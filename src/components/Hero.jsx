      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          ...
          <p className="text-slate-300 text-sm sm:text-base md:text-lg font-light max-w-3xl mx-auto leading-relaxed">
            {t('hero.subtext', 'Somos o núcleo criativo, técnico e experimental da Tentáculos Produções. Responsável por transformar ideias, necessidades e objetivos de uma marca em projetos visuais, cenográficos e experiências que possam ser compreendidos, apresentados e executados no mundo real.')}
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
            <div className="px-3.5 py-1.5 rounded bg-[#121D31]/90 border border-white/[0.08] text-xs">
              <span className="rotulo-tecnico text-[10px] text-slate-400 block mb-0.5">
                {t('hero.territory', 'TERRITÓRIO')}
              </span>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            >
              <span>{t('juxtapose.tag', 'Ver Comparativo 3D vs Real')}</span>
          ...
          <div className="pt-12 border-t border-white/[0.06] text-center space-y-3">
            <span className="rotulo-tecnico text-[10px] text-slate-400 block">
              {t('hero.festivalsLabel', 'TRAJETÓRIA & PRODUÇÕES DE GRANDE PORTE')}
            </span>
